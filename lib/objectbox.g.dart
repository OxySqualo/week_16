...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 8519480312025772895),
      name: 'Note',
      lastPropertyId: const IdUid(3, 6667396131876031504),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 8284317657781159059),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 4737570893390989720),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 6667396131876031504),
            name: 'description',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 8519480312025772895),
